...
class modelOrder {
	...
	function getOrder($batas,$baris,$data){
		...
		$sql = "select idpesanan,_order.pesanan_no,
				...
				pesanan_kurir,dari_poin,login_username 
				from _order 
				...
				left join _login on _order.input_by = _login.login_id ".$where." order by pesanan_tgl desc limit $batas,$baris";
	...
	public function simpanneworder($data){
		...
		$sql = "insert into _order 
				...
				(null,'".$data['nopesanan']."','".$data['cust_id']."',
				 ...
				 '".$data['kurir_konfirm']."','".$this->user."','','0')";
