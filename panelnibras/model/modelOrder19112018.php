	...
	public function simpanneworder($data){
		...
		*/
		...
		$sql = "insert into _order_penerima values 
				('".$data['nopesanan']."','".$data['nama_penerima']."',
				 '".$data['telp_penerima']."',
				 '".$data['alamat_penerima']."','33',
				 '".$data['propinsi_penerima']."','".$data['kabupaten_penerima']."',
				 '".$data['kecamatan_penerima']."','".$data['kelurahan_penerima']."',
		...
		$sql = "insert into _order_pengirim values
				('".$data['nopesanan']."','".$data['nama_pengirim']."',
				 '".$data['telp_pengirim']."','".$data['alamat_pengirim']."','33',
				 '".$data['propinsi_pengirim']."',
				 '".$data['kabupaten_pengirim']."',
				 '".$data['kecamatan_pengirim']."',
				 '".$data['kelurahan_pengirim']."',
