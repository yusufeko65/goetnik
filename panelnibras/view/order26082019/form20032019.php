			...
			<form autocomplete="off" method="POST" name="frmdata" id="frmdata" action="<?php echo $_SERVER['PHP_SELF'] ?>" class="form-horizontal">
			  ...
			  <?php } ?>
						...
						<tr>
							...
							<div class="col-md-12">
								<div class="row">
								<input type="checkbox" name="tampilketeranganlabel" id="tampilketeranganlabel" value="1" <?php echo $order['tampil_label_keterangan'] == '1' ? 'checked' : '' ?>> Tampil di Label Alamat ?
								</div>
							</div>
							<div class="input-group">
								
								<input type="text" id="keterangan" class="form-control" value="<?php echo $order['keterangan'] ?>">
								<span class="input-group-btn">
									<button class="btn btn-primary" id="updateketerangan" type="button">Update Keterangan</button>
								</span>
							</div><!-- /input-group -->
