			...
			<div class="modal-body">
				...
				<div role="tabpanel">
					...
					<ul class="nav nav-tabs" role="tablist">
						<li role="presentation" class="active"><a href="#updatestatus" aria-controls="updatestatus" role="tab" data-toggle="tab">Update Status</a></li>
						<li role="presentation"><a href="#riwayatstatus" role="tab" data-toggle="tab">Riwayat Status</a></li>
					</ul>
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane active" id="updatestatus">
							<div class="form-group">
								<label>Status</label>
								<?php echo $dtFungsi->cetakcombobox2('- Status Order -','',$stsnow,'orderstatus','_status_order','status_id','status_nama','form-control') ?>
							</div>
							<?php 
							...
							<div class="form-group" id="divketerangan" <?php echo $style ?>>
							...
							<div id="datasudahbayar" <?php echo $style ?>>
								...
								<div class="checkbox">
									<label>
										<input type="checkbox" id="kirimmailsudahbayar" name="kirimmailsudahbayar" value="1" checked> <span class="label label-default">Kirim Email ke Pelanggan ?</span>
									</label>
								</div>
							</div>
							...
							<div id="datapengiriman" <?php echo $style ?>>
								...
								<div class="checkbox">
									<label>
										<input type="checkbox" id="kirimmailship" name="kirimmailship" value="1" checked> <span class="label label-default">Kirim Email ke Pelanggan ?</span>
									</label>
								</div>
						...
						<div role="tabpanel" class="tab-pane" id="riwayatstatus">
...
$(function(){
   ...
   $( "#tglkirim" ).datepicker({ dateFormat: 'yy-mm-dd' });
});
</script>