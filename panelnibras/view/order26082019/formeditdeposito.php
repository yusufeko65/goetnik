<form method="POST" name="frmeditdeposito" id="frmeditdeposito" action="<?php echo $_SERVER['PHP_SELF'] ?>">
	...
	<input type="hidden" name="urlfolder" id="urlfolder" value="<?php echo isset($formdeposito['order']['pesanan_no']) ? URL_PROGRAM_ADMIN.folder.'?op=info&pid='.$formdeposito['order']['pesanan_no'] : '' ?>">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Form Potongan Deposito</h4>
			</div>
			...
			<div class="modal-body">
				...
				<div class="well">
					Pelanggan dapat mengubah jumlah potongan deposito dengan jumlah maksimal
				...
				<div class="col-lg-9">
					<div class="form-group">
						<div class="row">
							<label>Masukkan Jumlah Penggunaan dari Deposito</label>
							<input placeholder="Masukkan Jumlah Penggunaan dari Deposito" type="number" name="potongandeposit" id="potongandeposit" class="form-control form-control-sm">
						</div>
					</div>
				</div>
