 ...
 <div style="min-height:900px"> 
  ...
  <h2>ID ORDER : <?php echo $order[1] ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;VIA&nbsp;<?php
			    $tabel = "_order LEFT JOIN _order_intensif ON _order.pesanan_no = _order_intensif.pesanan_no";
		        $fieldambil = "user_id";
		        $fieldkondisi = "_order.pesanan_no";
		        $datavia = $order[1];
		        $cekvia = $dtFungsi->fcaridata($tabel,$fieldambil,$fieldkondisi,$datavia);
				if($cekvia != '' && !empty($cekvia)) {
				   $tabeladmin = "_login";
				   $fieldadmin = "login_username";
				   $fkondisi   = "login_id";
				   $dataadmin = $cekvia;
				   $namaadmin = $dtFungsi->fcaridata($tabeladmin,$fieldadmin,$fkondisi,$dataadmin);
				   echo ":&nbsp;$namaadmin";
				} else {
				   echo ":&nbsp;WEB";
				}
