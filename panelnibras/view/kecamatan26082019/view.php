	...
	<table class="table table-bordered table-striped table-hover tabel-grid">
	  ...
	  <tbody id="viewdata">
		...
		<tr>
		   ...
		   <td class="tengah"><a href="<?php echo URL_PROGRAM_ADMIN.folder."/?op=edit&pid=".$datanya['kecamatan_id']?>" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-pencil"></span></a></td>
		</tr>
		<?php } ?>
	   </tbody>
	 </table>
...
$(function(){
   ...
   $('#propinsi').change(function() {
		$('#kabupaten').load('<?php echo $_SERVER['PHP_SELF']?>?load=kabupaten&propinsi=' + this.value);
		return false;
	});
...
function caridata(){
   ...
   location='<?php echo URL_PROGRAM_ADMIN.folder.'/?datacari=' ?>'+zdata+'&propinsi='+propinsi+'&kabupaten='+kabupaten;
}
function hapusdata(){
	var ids = [];
	var dataId;
