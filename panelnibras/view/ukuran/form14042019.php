		  ...
		  <div class="widget-content nopadding">
	        <form class="form-horizontal" method="POST" name="frmdata" id="frmdata" onKeyPress="return disableEnterKey(event)" action="<?php echo $_SERVER['PHP_SELF'] ?>">
			  ...
			  <div class="form-group">
				 ...
				 <div class="col-sm-4">
				   <input type="text" id="ukuran" class="form-control" value="<?php echo $ukuran_nama ?>" size="40">
				 </div>
		      </div>
			  ...
			  <div class="form-group">
				 ...
				 <div class="col-sm-4">
				   <input type="text" id="alias" class="form-control" value="<?php echo $ukuran_alias ?>" size="40">
				 </div>
		      </div>
