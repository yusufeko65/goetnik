...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="LaporanKasMasuk<?php echo $dtFungsi->cariBulan($bulan-1).$tahun ?>">
  <Table>
   ...
   <Column ss:AutoFitWidth="0" ss:Width="90.00"/>
   <Row>
    <Cell ss:MergeAcross="10" ss:StyleID="judul"><Data ss:Type="String">Laporan Kas Masuk HijabSupplier.com</Data></Cell>
   </Row>
   <Row>
    <Cell ss:MergeAcross="10" ss:StyleID="subjudul"><Data ss:Type="String">Periode <?php echo $dtFungsi->cariBulan($bulan-1). ' '.$tahun ?></Data></Cell>
   </Row>
   <Row>
     <Cell ss:MergeAcross="10"></Cell>
   </Row>
   <Row>
	<Cell ss:MergeAcross="10" ss:StyleID="supersubjudul"><Data ss:Type="String">Print at <?php echo date('d M Y') ?></Data></Cell>
   </Row>
   <Row ss:Height="25">
 ...
 <?php 
	...
	foreach($dataview as $datanya) {
	  ...
	  $totBelanja = $totBelanja + $datanya["subtotal"];
  ...
  <Row>
	...
	<Cell ss:StyleID="kanan"><Data ss:Type="String"><?php echo $dtFungsi->fuang($datanya["subtotal"])?></Data></Cell>
...
<?php } ?>
   ...
   <Row ss:Height="25">
	...
	<Cell ss:StyleID="header" ss:Index="5"><Data ss:Type="String">Total Barang</Data></Cell>
	<Cell ss:StyleID="header" ss:Index="6"><Data ss:Type="String">Infaq</Data></Cell>
	<Cell ss:StyleID="header" ss:Index="7"><Data ss:Type="String">Keuntungan</Data></Cell>
	<Cell ss:StyleID="header" ss:Index="8"><Data ss:Type="String">Deposit</Data></Cell>
	<Cell ss:StyleID="header" ss:Index="9"><Data ss:Type="String">Kekurangan</Data></Cell>
	<Cell ss:StyleID="header" ss:Index="10"><Data ss:Type="String">Kas Masuk</Data></Cell>
   </Row>
   ...
   <Row>
	...
	<Cell ss:StyleID="kanan" ss:Index="5"><Data ss:Type="String"><?php echo $dtFungsi->fuang($totBarang)?></Data></Cell>
	<Cell ss:StyleID="kanan" ss:Index="6"><Data ss:Type="String"><?php echo $dtFungsi->fuang($totInfaq)?></Data></Cell>
	<Cell ss:StyleID="kanan" ss:Index="7"><Data ss:Type="String"><?php echo $dtFungsi->fuang($totLaba)?></Data></Cell>
	<Cell ss:StyleID="kanan" ss:Index="8"><Data ss:Type="String"><?php echo $dtFungsi->fuang($totDeposit) ?></Data></Cell>
	<Cell ss:StyleID="kanan" ss:Index="9"><Data ss:Type="String"><?php echo $dtFungsi->fuang($totKekurangan) ?></Data></Cell>
	<Cell ss:StyleID="kanan" ss:Index="10"><Data ss:Type="String"><?php echo $dtFungsi->fuang($totKM)?></Data></Cell>
   </Row>
  </Table>
