						...
						<div role="tabpanel" class="tab-pane active" id="tabketerangan">
							<div class="well">
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" id="kategori_nama" name="kategori_nama" class="form-control" value="<?php echo $kategori_nama ?>" size="40">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" id="kategori" name="kategori" class="form-control forms" autocomplete="off" value="<?php echo $namakat['name'] ?>" <?php echo $lock ?>>
