									...
									<table class="table table-bordered table-striped table-hover tabel-grid" id="option-value<?php echo $option_row ?>">
										...
										<?php if($dataallstokoption) { ?>
											...
											<tr id="option_row<?php echo $option_row ?>">
												...
												<td class="text-center"><a href="javascript:void(0)" onclick="formmodaleditstok(<?php echo $option_row ?>,<?php echo $idproduk ?>,<?php echo $stokoption['idukuran'] ?>,<?php echo $stokoption['idwarna'] ?>)" id="stok<?php echo $option_row ?>"><?php echo $stokoption['stok'] ?></a></td>
		...
		success: function(json){
			...
			if(json['status'] == 'error') {
				...
				for(i=0;i<datastok.length;i++)
				{
					...
					html += '<td class="text-center"><a href="javascript:void(0)" onclick="formmodaleditstok('+option_row+','+idproduk+','+datastok[i]['idukuran']+','+datastok[i]['idwarna']+')">'+datastok[i]['stok']+'</a></td>';
...
function formmodaleditstok(row,idproduk,idukuran,idwarna)
{
...
function simpaneditstokoption()
{
	...
	var stoklama	= $('#stok'+row).html();
	var data		= 'actiondata=editstok&idproduk='+idproduk+'&idwarna='+idwarna+'&idukuran='+idukuran+'&stok='+stok;
