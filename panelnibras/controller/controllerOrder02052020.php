...
class controllerOrder
{
	...
	public function tampildata()
	{
		...
		$result["rows"]    = $this->model->getOrder($offset, $rows, $data);
		$result["page"]    = $page;
		$result["baris"]   = $rows;
	...
	public function kirimNotifBayar($data)
	{
		...
		$message   = str_replace("[NAMA BANK DARI]", isset($datakonfirmasi['bank_dari']) ? $datakonfirmasi['bank_dari'] : '', $message);
		$message   = str_replace("[NO REK DARI]", isset($datakonfirmasi['bank_rek_dari']) ? $datakonfirmasi['bank_rek_dari'] : '', $message);
		$message   = str_replace("[ATASNAMA DARI]", isset($datakonfirmasi['bank_atasnama_dari']) ? $datakonfirmasi['bank_atasnama_dari'] : '', $message);
		$message   = str_replace("[NAMA BANK TUJUAN]", isset($cekbanktujuan['bank_nama']) ? $cekbanktujuan['bank_nama'] : '', $message);
		$message   = str_replace("[NO REK TUJUAN]", isset($cekbanktujuan['rekening_no']) ? $cekbanktujuan['rekening_no'] : '', $message);
		$message   = str_replace("[ATASNAMA TUJUAN]", isset($cekbanktujuan['rekening_atasnama']) ? $cekbanktujuan['rekening_atasnama'] : '', $message);
