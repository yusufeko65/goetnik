		...
		<form name="frmcart" id="frmcart" autocomplete="off">
			...
			<div class="row shopingcart">
				...
				<div class="col-12">
					<div class="row">
						<div class="col-md-12">
							<button class="btn btn-info btn-block" id="button-update">Simpan Perubahan</button><Br>
						</div>
						<div class="col-md-6"><a href="<?php echo URL_PROGRAM ?>" class="btn btn-outline-secondary btn-block">Belanja Lagi</a></div>
						<div class="col-md-6 text-right"><a href="<?php echo URL_PROGRAM.'cart/checkout' ?>" class="btn btn-outline-success btn-block">Bayar ke Kasir</a></div>
					</div>
				</div>
				<?php } ?>
			</div>
