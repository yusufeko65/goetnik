       ...
       <div id="hasil" style="display: none;"></div> 
		...
		<div class="col-md-12">
		   <div class="row">
		    ...
		    <div class="well text-right"><b><?php echo $dtFungsi->terbilang($subtotal) ?> Rupiah</b></div>
		  ...
		  <?php $servis = $dtShipping->getServis($ship['tabel']) ?>
		   ...
		   <?php } ?>
			...
			<div class="well">
			  ...
			  <div class="col-md-4">
			   <input type="text" class="form-control input-sm" name="poinku" placeholder="Masukkan Poin Anda">
			  </div>
			  <div class="clearfix"></div>
			</div>
			<div class="clearfix"></div>
