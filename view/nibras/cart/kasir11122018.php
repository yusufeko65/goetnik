					...
					<div class="row">
								...
								<div class="form-group">
									...
									<select class="custom-select form-control" name="serviskurir" id="serviskurir">
										...
										<?php foreach($servis as $ship) {?>
											<?php if($ship['shipping_konfirmadmin'] != '1') { ?>
											<option value="<?php echo $ship['servis_id'] ?>"><?php echo $ship['shipping_kode'].' - '.$ship['servis_code'].' ('.$ship['keterangan'].' Hari) - '.$ship['hrg_perkilo']?></option>
											<?php } else { ?>
											<option value="<?php echo $ship['servis_id'] ?>"><?php echo $ship['shipping_kode'].' - '.$ship['servis_code'].' - '.$ship['hrg_perkilo']?></option>
											<?php } ?>
										<?php } ?>
										<?php } ?>
									<select>
						...
						<div class="col-md-12">
							<ul class="list-group">
								...
								<?php if($reseller['cg_deposito'] == '1' && $reseller['cd_deposito'] > 0) { ?>
