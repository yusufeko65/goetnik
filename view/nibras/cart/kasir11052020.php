							...
							<div class="plat-alamat-detail" <?php echo $grup_dropship == '0' ? "style=display:none" : '' ?>>
								...
								<div id="alamatpengirim">
									<div class="align-items-center">
										...
										<input type="hidden" name="propinsi_pengirim" id="propinsi_pengirim">
										<input type="hidden" name="kabupaten_pengirim" id="kabupaten_pengirim">
										<input type="hidden" name="kecamatan_pengirim" id="kecamatan_pengirim">
										<input type="hidden" name="kelurahan_pengirim" id="kelurahan_pengirim">
										<input type="hidden" name="kodepos_pengirim" id="kodepos_pengirim">
									</div>
								</div>
							</div>
						</div>
									...
									<select class="custom-select form-control" name="serviskurir" id="serviskurir">
										...
										<?php if ($servis_ondb) { ?>
											<?php foreach ($servis_ondb as $servdb) { ?>
												<option value="<?php echo $servdb['servis_id'] ?>::Konfirmasi Admin::<?php echo $servdb['shipping_kode'] ?>::<?php echo $servdb['servis_code'] ?>"><?php echo $servdb['shipping_kode'] . ' - ' . $servdb['servis_code'] . ' - ' . $servdb['hrg_perkilo'] ?></option>
											<?php } ?>
										<?php } ?>
										<select>
