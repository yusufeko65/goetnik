		...
		<?php } ?>
		  ...
		  <?php $servis = $dtShipping->getServis($ship['tabel']) ?>
		   ...
		   <?php } ?>
			...
			<h4>POIN SUDAH YANG ANDA MILIKI (<?php echo $reseller['cp_poin'] > 0 ? $reseller['cp_poin']:0 ?>)</h4>
			<div class="well">
			  <div class="col-md-8 text-right">
			    Masukkan Poin Anda
			  </div>
			  <div class="col-md-4">
			   <input type="number" class="form-control input-sm" name="poinku" placeholder="Masukkan Poin Anda">
			  </div>
			  <div class="clearfix"></div>
			</div>
