					...
					<div class="well description">
						...
						<div class="form-group row">
							...
							<div class="col-md-5"> 
								...
								<?php if($jmlukuran > 1) { ?>
								<select id="ukuran" name="ukuran" class="form-control custom-select form-control-sm" onchange="pilihwarna(this.value,'<?php echo $pid; ?>','<?php echo $detail['head_produk']?>','<?php echo $persen ?>','<?php echo $detail['sale'] ?>')">
						...
						<div class="form-group row">
							<label class="col-md-3 col-form-label label-reguler">Stok</label>
							<div class="col-md-3">
						...
						<?php if($warna){ ?>
						<div class="form-group row">
							<label class="col-md-3 col-form-label label-reguler">Warna</label>
							<div class="col-md-6"> 
								<input type="text" id="jmlwarna" readonly class="form-control-plaintext text-bold" value="<?php echo count($warna) ?> warna">
						...
						<div class="form-group row">
							<div class="col-md-8">
								...
								<div class="col-md-12" id="keteranganwarna">
									<div class="row">
										Warna yang dipilih :  <b><span id="nama_warna"> - </span></b>
									</div>
								</div>
							</div>
						</div>	
						<?php } ?>
						<div class="form-group row">
							<label class="col-md-3 col-form-label label-reguler">Jumlah</label>
							<div class="col-md-5">
