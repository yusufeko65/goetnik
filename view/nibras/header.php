...
<head>
	...
	<meta name="googlebot" content="all, index, follow">
        <meta name="google-site-verification" content="8oLuy3Qd2osAfCxV_SLZmK3g-jlRznKsObu4KyrZSlM" />
	...
	<script type="text/javascript" src="<?php echo URL_THEMES ?>assets/js/jquery-3.3.1.min.js"></script>
	<script type="text/javascript" src="<?php echo URL_THEMES ?>assets/jqueryui/jquery-ui.min.js"></script>
	<script async src="https://app.notifybooster.com/pixel/9b447d4590254780456e0e3f01fc2256"></script>
</head>
...
<body>
						...
						<ul class="nav">
							...
							<li class="nav-item dropdown">
								...
								<div class="dropdown-menu">
									...
									<a class="dropdown-item" href="<?php echo URL_PROGRAM . 'admin' ?>">Admin</a>
					...
					<ul class="navbar-nav mr-auto">
						...
						<?php if ($kategori) { ?>
							...
							<?php foreach ($kategori as $kat) { ?>
								...
								<?php    } else { ?>
									<li><a class="nav-link" href="<?php echo URL_PROGRAM . (isset($kat['alias']) ? $kat['alias'] : '') ?>"><?= (isset($kat['nama']) ? $kat['nama'] : '') ?></a></li>
								<?php    } ?>
							<?php } ?>
						<?php } ?>
	...
	<div class="container">
		<div class="col-md-12">
			<?php if ($idmember != '') { ?>
				<h4 class="grup_member">Hai Kak, <?php print($namamember) ;?> <span class="badge badge-pill badge-info"><?php echo $grup_nama ?></span></h4>
			<?php } ?>
		</div>
	</div>
