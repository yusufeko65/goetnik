			...
			<div class="plat-order">
				<div class="row">
					...
					<div class="col-md-6">
						...
						<b>Status</b> : <?php echo $dataorder['status_nama']; ?> <?php echo $config_orderstatus == $dataorder['status_id'] ? "<a href=\"".URL_PROGRAM ."konfirmasi\?order=".$dataorder['pesanan_no']."\">[Form Konfirmasi Pembayaran]</a>" : '' ?> <?php echo $config_orderstatus != $dataorder['status_id'] && $config_ordercancel != $dataorder['status_id']  ? "<button type='button' data-toggle=\"modal\" data-target=\"#detailPembayaran\" class=\"btn btn-sm btn-info\">[Detail Pembayaran]</button>" : '' ?><br>
			...
			<div class="row">
				...
				<div class="form-group">
					...
					<div class="input-group">
						<input type="text" class="form-control" name="keterangan" id="keterangan" <?php echo $readonly ?> value="<?php echo $dataorder['keterangan'] ?>" placeholder="Keterangan Tambahan" aria-describedby="update_keterangan">
						<div class="input-group-append">
							<button class="btn btn-primary" <?php echo $readonly ?>  type="button" id="update_keterangan">Update Keterangan</button>
						</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group-modal row">
					...
					<div class="col-md-9">
						<input type="text" readonly class="form-control-plaintext form-control-sm"  value="<?php echo $dataorder['rekening_no'] ?>">
					</div>
				</div>
				<div class="form-group-modal row">
					<label class="col-md-3 col-form-label">Atas Nama : </label>
					<div class="col-md-9">
						<input type="text" readonly class="form-control-plaintext form-control-sm"  value="<?php echo $dataorder['rekening_atasnama'] ?>">
					</div>
				</div>
				-->
				<hr>
