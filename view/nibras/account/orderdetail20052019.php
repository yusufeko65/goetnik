	...
	<form id="frmorder" autocomplete="off" action="<?php echo URL_PROGRAM . 'orderdetail' ?>">
		...
		<div class="col-sm-12">
			...
			<table class="table table-bordered">
				...
				<?php 
				?>
				<?php if ($dataorder['dari_deposito'] > 0) { ?>
				...
				<tr>
					...
					<td class="text-right"><b><?php echo $dataorder['kurir_konfirm'] == '1' ? 'Konfirmasi Admin' : $dtFungsi->fFormatuang(((int)$dataorder['pesanan_subtotal'] + (int)$dataorder['pesanan_kurir']) - (int)$dataorder['dari_poin'] - (int)$dataorder['dari_deposito']) ?></b></td>
				</tr>
