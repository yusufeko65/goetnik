	...
	<body>
		...
		<header>
							...
							<li class="nav-item dropdown">
								...
								<div class="dropdown-menu">
									<div class="px-0 container">
										<a class="dropdown-item" href="<?php echo URL_PROGRAM.'login'?>">Login</a>
										<a class="dropdown-item" href="<?php echo URL_PROGRAM.'daftar'?>">Daftar</a>
									</div>
								</div>
							</li>
						<?php } else { ?>
									...
									<div class="container">
										...
										?>
											<div class="col-md-12 list-lastorder-item">
												<div class="row">
													<div class="col-md-6">
														#<?php echo sprintf("%08s",$order['pesanan_no']) ?><br>
							...
							<li class="nav-item dropdown">
								...
								<div class="dropdown-menu">
									<div class="px-0 container">
										...
										<a class="dropdown-item" href="<?php echo URL_PROGRAM.'deposito'?>">Data Deposito</a>
					...
					<div class="col-4 plat-cart">
						...
						<div class="list-cart">
							<?php if($jmlitem > 0) { ?>
									...
									<?php } ?>
									<div class="col-md-12">
										<a href="<?php echo URL_PROGRAM .'cart' ?>" class="btn btn-outline-danger btn-block"><i class="fa fa-shopping-basket" aria-hidden="true"></i> Keranjang Belanja</a>
									</div>
									<br>
							<?php } else { ?>
			...
			<nav class="navbar navbar-expand-lg navbar-light" id="menu">
								...
								<div class="dropdown-menu">
									<div class="row">
										...
										<?php foreach ($kat['children'] as $child) { ?>
											<a class="dropdown-item" href="<?php echo URL_PROGRAM.$child['alias'] ?>"><?php echo $child['nama']; ?></a>
										<?php } ?>
										</div>
									</div>
								</div>
				...
				<?php } ?>
							<li class="nav-item">
								<a class="nav-link" href="<?php echo URL_PROGRAM ?>">Konfirmasi Pembayaran</a>
							</li>
						</ul>
