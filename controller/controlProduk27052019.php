...
class controller_Produk
{
	...
	public function tampildata($jenis, $id, $rows)
	{
		...
		$data['sortir']		= isset($_GET['sort']) ? $_GET['sort'] : 'new';
  ...
  */
	...
	public function getLapProdukByKategori($kategori = 0, $search, $baris = 10)
	{
		...
		$result["rows"] = $this->dataModel->getProdukByKategori($kategori, $this->offset, $this->rows, $search);
		$result["total"]   = $this->dataModel->totalProdukByKategori($kategori, $search);
		$result["page"]    = $this->page;
