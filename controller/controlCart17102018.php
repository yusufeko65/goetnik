   ...
   public function __construct(){
	...
	public function simpanorder(){
		...
		if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_SESSION['idmember'])) {
			...
			//$hargaperkilo = isset($dataservis['hrg_perkilo']) ? $dataservis['hrg_perkilo'] : 0;
			...
			if($simpan){
				...
				*/
				...
				/* kurir */
				$tabel	.= "<tr style=\"margin:0;padding:0\">";
				$tabel .= "<td colspan=\"4\" style=\"text-align:right;margin:0;padding:10px\" align=\"right\" bgcolor=\"#ffffff\"><b>".$data['servis_code']. ' - '.$datashipping['shipping_kode']."</b> </td>";
