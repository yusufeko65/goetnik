		...
		if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_SESSION['idmember'])) {
			...
			if($simpan){
				...
				*/
				...
				/* kurir */
				$tabel	.= "<tr style=\"margin:0;padding:0\">";
				$tabel .= "<td colspan=\"6\" style=\"text-align:right;margin:0;padding:10px\" align=\"right\" bgcolor=\"#ffffff\"><b>".$data['servis_code']. ' - '.$datashipping['shipping_kode']."</b> </td>";
				...
				$alamatpengirim  .= $data['nama_pengirim'].' <br>';
