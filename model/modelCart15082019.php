...
class model_Cart
{
	...
	function simpanorder($data)
	{
		...
		$sql = "insert into _order 
				...
				'" . $data['kurir_konfirm'] . "',0,'" . htmlentities($this->db->escape($data['keterangan'])) . "','0')";
		...
		*/
		...
		$sql = "insert into _order_penerima values 
				('" . $data['nopesanan'] . "','" . htmlentities($this->db->escape($data['nama_penerima'])) . "',
				 '" . $data['telp_penerima'] . "',
				 '" . htmlentities($this->db->escape($data['alamat_penerima'])) . "','33',
				 '" . $data['propinsi_penerima'] . "','" . $data['kabupaten_penerima'] . "',
				 '" . $data['kecamatan_penerima'] . "','" . htmlentities($this->db->escape($data['kelurahan_penerima'])) . "',
				 '" . htmlentities($this->db->escape($data['kodepos_penerima'])) . "')";
		...
		$sql = "insert into _order_pengirim values
				('" . $data['nopesanan'] . "','" . htmlentities($this->db->escape($data['nama_pengirim'])) . "',
				 '" . htmlentities($this->db->escape($data['telp_pengirim'])) . "','" . htmlentities($this->db->escape($data['alamat_pengirim'])) . "','33',
				 '" . $data['propinsi_pengirim'] . "',
				 '" . $data['kabupaten_pengirim'] . "',
				 '" . $data['kecamatan_pengirim'] . "',
				 '" . htmlentities($this->db->escape($data['kelurahan_pengirim'])) . "',
				 '" . htmlentities($this->db->escape($data['kodepos_pengirim'])) . "')";
		$strsql = $this->db->query($sql);
		if (!$strsql) {
	...
	public function SimpanOrderPenerima($data)
	{
		...
		*/
		$sql = "insert into _order_penerima values ('" . $data['nopesanan'] . "',
		                   '" . htmlentities($this->db->escape($data['nama'])) . "','" . $data['telp'] . "',
						   '-','" . htmlentities($this->db->escape($data['alamat'])) . "',
						   '" . $data['negara'] . "','" . $data['propinsi'] . "',
						   '" . $data['kabupaten'] . "','" . $data['kecamatan'] . "',
						   '" . htmlentities($this->db->escape($data['kelurahan'])) . "','" . htmlentities($this->db->escape($data['kodepos'])) . "')";
		return $sql;
	}
	...
	public function SimpanOrderPengirim($data)
	{
	    ...
	    */
		$sql = "insert into _order_pengirim values ('" . $data['nopesanan'] . "',
		                   '" . htmlentities($this->db->escape($data['namapengirim'])) . "','" . $data['telppengirim'] . "',
						   '-','" . htmlentities($this->db->escape($data['alamatpengirim'])) . "',
						   '" . $data['negarapengirim'] . "','" . $data['propinsipengirim'] . "',
						   '" . $data['kabupatenpengirim'] . "','" . $data['kecamatanpengirim'] . "',
						   '" . htmlentities($this->db->escape($data['kelurahanpengirim'])) . "','" . htmlentities($this->db->escape($data['kodepospengirim'])) . "')";
		return $sql;
	}
