...

{
...

	{
		...
		*/
		...
		/* simpan order status */
		$_idmem = isset($_SESSION['idmember']) && !empty($_SESSION['idmember'])?$_SESSION['idmember']:'-99';
		$sql = "insert into _order_status values 

				(null,'" . $data['nopesanan'] . "','" . $tgltransaksi . "',

				'" . $data['status_order'] . "','','".$_idmem."')";
...

	{
		...
		*/
		...
		$data['adminid'] = isset($data['adminid'])?$data['adminid']:'-';

		$sql = "insert into _order_status values ('','" . $data['nopesanan'] . "',

		       '" . $data['tgltrans'] . "','" . $data['orderstatus'] . "','','". $data['adminid'] ."')";
